...
describe("Conversão de inteiro para extenso", () => {
  test("deve retornar erro para números negativos", () => {
    expect(() => {
      integerToWords(-1);
    }).toThrow(new RangeError("Number out of range para o numero conversion."));
  });

  describe("números do 1 ao 9", () => {
  ...
  test("deve retornar Vinte e Sete para o numero 27", () => {
